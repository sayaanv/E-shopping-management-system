  ...
  switch(choice)
  {
   case 1:
   {
    ...
    switch(accessoriesChoice)
    {
     ...
     {
      int num;
      printf("You chose Headphone with Rs.655.Are you sure to buy.If 'Yes' Enter 1 else any number\n");
      scanf("%d",&num);
      if(num==1)
      {
       a[0]++;
     ...
     {
      int num;
      printf("You chose Pendrive 64GB with Rs.950.Are you sure to buy.If 'Yes' Enter 1 else any number\n");
      scanf("%d",&num);
      if(num==1)
      {
       a[2]++;
   ...
   {
    int mobileChoice;
    printf("Enter\n1 - Mi Note 7 - Rs.11000\n2 - Nokia 3 - Rs.9866\n3 - Samsung A15 - Rs.12800\nAny other number to exit\n");
    ...
    switch(mobileChoice)
    {
     ...
     {
      int num;
      printf("You chose to buy Mi Note 7 for Rs.11000.Are you sure to buy.If 'Yes' Enter 1 else any number\n");
      scanf("%d",&num);
      if(num==1)
      {
       a[6]++;
     ...
     {
      int num;
      printf("You chose to buy Samsung A15 for Rs.12800.Are you sure to buy.If 'Yes' Enter 1 else any number\n");
      scanf("%d",&num);
      if(num==1)
      {
       a[8]++;
